"""Add mega_themes, narrative_mega_themes, mega_theme_mentions_daily for LLM-derived overarching themes.

Revision ID: 0016_mega_themes
Revises: 0015_theme_parent
...
revision = "0016_mega_themes"
down_revision = "0015_theme_parent"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    if "narrative_mega_themes" not in tables:
        op.create_table(
    ...
    if "mega_theme_mentions_daily" not in tables:
        op.create_table(
